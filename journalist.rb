...
#Q1
def taille_array(array)
    
    return array.length
end

def contient_nombre?(array)
    counter =0
...
puts taille_array(my_array)

puts contient_nombre?(my_array)

puts compter_aude(my_array)

puts commence_majuscule(my_array)

puts contient_majuscule(my_array)

puts nombre_underscore(my_array)

puts trie_tableau(my_array)
